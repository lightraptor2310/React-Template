...
const Person = () => {
  ...
  return (
    <>
        ...
        <div className="fullName  bg-white shadow-md p-3 rounded-md w-full text-lg text-center"><p> <span className='font-semibold'>Họ và tên: </span>{StudentInfo?.TenSV}</p></div>
        <div className="student-info flex md:flex-row flex-col gap-2">
            <div className="student-id bg-white shadow-md p-3 rounded-md md:w-1/2 w-full text-lg text-center"><p><span className='font-semibold'>Mã sinh viên: </span>{StudentInfo?.MaSV}</p></div>
            <div className="student-class bg-white shadow-md p-3 rounded-md md:w-1/2 w-full text-lg text-center"><p><span className='font-semibold'>Giới tính: </span>{StudentInfo?.GioiTinh}</p></div>
        </div>
        <div className="student-info flex md:flex-row flex-col gap-2">
            <div className="student-id bg-white shadow-md p-3 rounded-md md:w-1/2 w-full text-lg text-center"><p><span className='font-semibold'>Quê quán: </span>{StudentInfo?.NoiSinh}</p></div>
            <div className="student-class bg-white shadow-md p-3 rounded-md md:w-1/2 w-full text-lg text-center"><p><span className='font-semibold'>Địa chỉ: </span>{StudentInfo?.DiaChi}</p></div>
        </div>
        <div className="phuhuynh text-center text-xl font-semibold bg-white shadow-md p-3 rounded-md w-full">
            <p>Thông tin phụ huynh</p>
        </div>
        {
            StudentInfo?.PhuHuynh?.map((item,index) => (
